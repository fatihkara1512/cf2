                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                             ...
                                             SELECT (yemler.id) as yemid,hayvan.numara,hayvan.tur,
                                             hayvan.kilo,(yemler.miligram) as yem,yemler.tarih
                                            FROM hayvan
                                             ...
                                             ORDER BY yemler.id DESC;
                                                ...
                                                <td>#x.yem#</td>
                                                <td>#x.tarih#</td>
                                              <td><i class="fa fa-trash sil" id="#x.yemid#" style="cursor:pointer;" aria-hidden="true"></i></td>
...
<div class="table table-bordered">
    ...
    <div class="col-sm-12">
                ...
                <div class="form-group row">
                    <label for="yem" class="col-sm-2 col-form-label">Yem Miktarı</label>
                    <div class="col-sm-10">
                    <input type="yem" class="form-control" id="yem" placeholder="Yem (mg)">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-2">
...
var yem=$("#yem").val();
$.ajax({
url:"ekle/yem-ekle.cfm", 
data :{ canli: canli,yem:yem},
...
$.ajax({
url:"delete.cfm", 
data :{ tablo:"yemler",id:$(this).attr("id")},
success : function(response){
